...
class TestUrlsWithReviewerUser(TestCase):
    ...
    def setUp(self):
        ...
        self.reviewer_appuser = AppUser.objects.create(
        ...
        self.application2_eligible = Application.objects.create(
            student=self.student_appuser,
    ...
    def test_reviewer_can_change_status_to_allowed(self):
    ...
    def test_reviewer_can_change_status_to_invalid(self):
        url = reverse('abroadhub:application-change-status', args=[self.application2_eligible.id])
    ...
    def test_change_payment_status_url_fail(self):
        url = reverse('abroadhub:application-change-payment-status', args=[self.application1_applied.id])
