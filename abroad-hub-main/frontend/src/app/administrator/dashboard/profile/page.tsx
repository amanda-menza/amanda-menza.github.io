      ...
      <div className="flex flex-col items-center space-y-6">
        ...
        {!appUser.is_sso && (
          <div className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg">
            <Button
              onClick={() =>
                router.push("/administrator/dashboard/profile/change-password")
              }
              className="mt-4 w-full bg-[var(--theme-color)] text-gray-600 hover:bg-[var(--theme-color)]"
            ...
            <Button
              onClick={() =>
                router.push("/administrator/dashboard/profile/mfa-settings")
              }
              className="mt-4 w-full bg-[var(--theme-color)] text-gray-600 hover:bg-[var(--theme-color)]"
              style={{ color: 'var(--secondary-color)' }}
            >
